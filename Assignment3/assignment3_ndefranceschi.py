...
def WoodResistanceCalculatorwithLibrary(ListofResistance):
    ...
    return R_value
Rval_new=WoodResistanceCalculatorwithLibrary(ResistanceList)
print("The resistance values with wood are " + str(Rval_new))
...
def InsulationResistanceCalculatorwithLibrary(ListofInResistance):
    ...
    return R_value
Rval_new=InsulationResistanceCalculatorwithLibrary(ResistanceList)
print("The resistance values with insulation are " + str(Rval_new))
