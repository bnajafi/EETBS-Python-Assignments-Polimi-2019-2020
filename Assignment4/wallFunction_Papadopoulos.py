...
T1=22.0 #T1=raw_input("give the inside temp:" ) #the inside is 22deg.Celsius
T2=-2.0 #T2=raw_input("give the outside temp:" ) #the outside is -2 deg.Celsius
